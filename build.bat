...
python -m PyInstaller ^
    ...
    --hidden-import vjvisual.dejavu_sqlite ^
...
echo.
echo === SUCCESS ===
echo Single-EXE output: dist-onefile\VJ-Visual.exe
echo.
